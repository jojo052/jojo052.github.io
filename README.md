...
- 个人资料与三个商汤项目的简要描述来自用户提供的 VLM/VLA 简历。
- 商汤时间采用用户于本次对话明确提供的 2026 年 6 至 8 月，覆盖简历原有的 5 至 8 月。
- SmolVLA 简介参考 GitHub README，只写实验范围，未宣称蒸馏已恢复成功率或完成异步评测。
- 详细指标、项目图片、视频、其他项目链接等待补充。项目陈述尚未经过独立实验复核。
